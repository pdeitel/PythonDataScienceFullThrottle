...
public class CannonGame extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Cannon cannon = new Cannon(50, 384);
        root.getChildren().add(cannon.getShape());
    ...
    class Cannon {
        ...
        public Cannon(double x, double y) {
            barrel = new Rectangle(x, y - 15, 80, 30); // Adjusted size to match the image
        ...
        public CannonBall fire(double targetX, double targetY) {
            ...
            barrel.setRotate(Math.toDegrees(angle)); // Rotate the barrel to point in the direction of fire
            return new CannonBall(barrel.getX() + barrel.getWidth(), barrel.getY() + barrel.getHeight() / 2, angle);
        }
    }
